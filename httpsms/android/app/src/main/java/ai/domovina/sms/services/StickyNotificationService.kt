package ai.domovina.sms.services
...
import ai.domovina.sms.MainActivity
import ai.domovina.sms.R
...
class StickyNotificationService: Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return builder
            .setContentTitle("Domovina SMS")
            .setContentText("Domovina SMS prati slanje i primanje SMS poruka u pozadini.")
